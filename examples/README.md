...
This folder contains example code for using the BIN Lookup API across different platforms.
...
const response = await fetch('https://api.apiverve.com/v1/binlookup', {
...
response = requests.get('https://api.apiverve.com/v1/binlookup',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/binlookup");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/binlookup](https://docs.apiverve.com/ref/binlookup)
